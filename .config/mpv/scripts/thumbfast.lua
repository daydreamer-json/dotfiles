...
local function spawn(time)
    ...
    local args = {
        ...
        -- Vulkan, iGPUを明示する設定を追加
        "--vulkan-device=8680a646-0c00-0000-0002-000000000000", "--gpu-context=waylandvk", "--gpu-api=vulkan",
        ...
        -- autoではなくvaapiを使用
        "--vd-lavc-skiploopfilter=all", "--vd-lavc-software-fallback=1", "--vd-lavc-fast", "--vd-lavc-threads=2", "--hwdec="..(options.hwdec and "vaapi" or "no"),
